			...
			<div id="main">
				...
				<?php
					...
					if(isset($_GET['categoryName']))
					{
						...
						{
							echo "<p>Choose other category, please.</p>";
						}
						else
						{
							$changedCategoryName=replace_dashes($categoryName); //menjam crtice
							echo "<h4>$changedCategoryName</h4>"; 
							while($row=mysqli_fetch_object($result))
							{
					...
					else echo "<p>Choose category, please.</p>";
